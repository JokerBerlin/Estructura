...
public void R_repaint(){
        for (int j = 0; j < i; j++) {
            for (int k = 0; k < i; k++) {
                ...
                Pintar.pintarLinea(JGrafos.jPanel1.getGraphics(),arboles.getCordeX(j),arboles.getCordeY(j), arboles.getCordeX(k), arboles.getCordeY(k),arboles.getmCoeficiente(j, k));
            }
        }
        for (int j = 0; j < i; j++) {
            Pintar.pintarCirculo(JGrafos.jPanel1.getGraphics(), arboles.getCordeX(j),arboles.getCordeY(j),String.valueOf(arboles.getNombre(j)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Error.. Faltan datos : ");
            ...
            JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
                ...
                n1.setText(null);
                n2.setText(null);
                JGrafos.jPanel1.paint(JGrafos.jPanel1.getGraphics());
