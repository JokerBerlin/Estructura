 ...
 * @author Marko
 */
public class JListaDoble extends javax.swing.JFrame {

    /**
     * Creates new form JListaDoble
     */
    public JListaDoble() {
        initComponents();
        this.setLocationRelativeTo(null);
        /*ImageIcon imagen = new ImageIcon("src/Imagenes/Image2.jpg");
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnCrear, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 29, 131, -1));
        ...
        getContentPane().add(btnInsertarI, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 69, 131, -1));
        ...
        getContentPane().add(btnInsertarF, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 133, 131, -1));
        ...
        getContentPane().add(btnEliminarI, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 163, 131, -1));
        ...
        getContentPane().add(btnEliminarF, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 226, 131, -1));
        ...
        getContentPane().add(btnEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 255, 131, -1));

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 48, 180, 210));

        jButton1.setText("Insertar Despues De");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 103, -1, -1));

        jButton3.setText("Elimiar Buscado");
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 197, 131, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 100, 20));

        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Image2.jpg"))); // NOI18N
        getContentPane().add(Fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(-180, 0, 560, 300));
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        a = new ListaD();
        JOptionPane.showMessageDialog(null, "Lista Doble Creada");
    ...
    private void btnInsertarIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarIActionPerformed
        ...
        a.insertarI(Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese elemento")));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        a.insertarDespuesD(a, Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese elemento")));
        jTextArea1.setText("Lista: \n" + a.toString());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try {
            a.elimnarElementoB(Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese elemento")));
        } catch (Exception ex) {
            JOptionPane.showInputDialog(null, "Lista Vacia");
        }
        jTextArea1.setText("Lista: \n" + a.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JListaDoble.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
